...
export function PillNav({
  ...
  return (
    <div className='pill-nav-container relative'>
        ...
        {items?.[0] && isRouterLink(items[0].href) ? (
          ...
          >
            {typeof logo === 'string' ? (
              ...
              <span ref={logoImgRef as React.RefObject<HTMLSpanElement>}>{logo}</span>
            )}
          </Link>
        ) : (
          <a
      ...
      <div className='mobile-menu-popover mobile-only shadow-xl' ref={mobileMenuRef} style={cssVars}>
