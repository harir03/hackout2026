...
const FARMER_QUESTIONS_BY_LANG: Record<string, Array<{ q: string; options: string[] }>> = {
  ...
  hi: [
    ...
    { q: "आपकी फसल बीमा कवरेज स्थिति (प्रधानमंत्री फसल बीमा योजना) क्या है?", options: ["हर सीजन में पूरी तरह से बीमित", "केवल प्रमुख फसलों के लिए बीमित", "शायद ही कभी बीमित", "�  gu: [
